    ...
    <section class="mt-16 text-center w-full">
        ...
        <div class="mt-8 grid md:grid-cols-3 gap-6">
            <div class="rounded-3xl border bg-white p-6 text-left">
                ...
                <a href="#events"
                    class="mt-4 inline-flex items-center text-indigo-600 font-semibold hover:underline">Mulai Cari <i
            ...
            <div class="rounded-3xl bg-indigo-600 text-white p-6 text-left shadow-md">
                ...
                <a href="{{ route('events.list') }}" class="mt-4 inline-flex items-center font-semibold hover:underline">Pelajari <i
                        class="fa-solid fa-arrow-right ml-2 text-sm"></i></a>
            </div>
            <div class="rounded-3xl border bg-white p-6 text-left">
                ...
                <a href="{{ route('events.calendar') }}"
                    class="mt-4 inline-flex items-center text-indigo-600 font-semibold hover:underline">Lihat Jadwal <i
                        class="fa-solid fa-arrow-right ml-2 text-sm"></i></a>
            </div>
        </div>
    </section>
