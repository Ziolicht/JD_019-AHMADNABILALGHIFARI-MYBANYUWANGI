<nav id="mainNavbar" x-data="{ open: false }" class="bg-white border-b shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <a href="/" class="block px-3 py-2 text-gray-600 hover:bg-gray-100 rounded">Beranda</a>
                <a href="#events" class="block px-3 py-2 text-gray-600 hover:bg-gray-100 rounded">Event</a>
                <a href="" class="block px-3 py-2 text-gray-600 hover:bg-gray-100 rounded">Tentang</a>
                <a href="/#footer" class="block px-3 py-2 text-gray-600 hover:bg-gray-100 rounded">Kontak</a>
            </div>
